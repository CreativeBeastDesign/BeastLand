...
<script lang="ts">
  ...
  import { projectStatusLabels } from "../../project/types.js";
  ...
  import { customerName, documentTotals, formatDate, formatMoney } from "../../data/format.js";
  import { worklog, clock } from "../../worklog/store.svelte.js";
  import { entryMinutes, formatDuration, dayKey, timeOfDay } from "../../worklog/types.js";
  import { kinds } from "../../tiling/kinds.svelte.js";
    import { commandBridge, runBridge } from "../../shell/bridge.js";

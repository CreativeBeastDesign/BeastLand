...
<script lang="ts">
  ...
  import { candidatesFor, applySuggestion, splitInput } from "../../shell/completion.js";
  import { linkify, isAllowedLinkHref } from "../../shell/linkify.js";
  import { applyAutoPair, applyAutoPairBackspace } from "../../shell/autopair.js";
  import { registry } from "../../shell/registry.svelte.js";
  import { shell } from "../../shell/state.svelte.js";
  import { loadHistory, persistHistory, HISTORY_CAP } from "../../shell/history.js";
  import { initHistoryNav, navigateDown, navigateUp, resetHistoryNav, type HistoryNavState } from "../../shell/history-nav.js";

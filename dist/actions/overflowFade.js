...
function update(node) {
    ...
    if (clippedTop && clippedBottom)
        node.dataset.overflow = "both";
    else if (clippedTop)
        node.dataset.overflow = "top";
    else if (clippedBottom)
        node.dataset.overflow = "bottom";
    else
    ...
    if (clippedLeft && clippedRight)
        node.dataset.overflowX = "both";
    else if (clippedLeft)
        node.dataset.overflowX = "left";
    else if (clippedRight)
        node.dataset.overflowX = "right";
    else
        delete node.dataset.overflowX;
}

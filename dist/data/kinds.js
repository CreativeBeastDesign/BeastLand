...
import { handleItem, itemFieldFlags } from "../tiling/commands.js";
...
import CustomerTile from "../components/tiles/CustomerTile.svelte";
import DocumentTile from "../components/tiles/DocumentTile.svelte";
import { customerFieldFlags, customerFieldsFromFlags, documentFieldFlags, documentFieldsFromFlags, } from "./fields.js";
export const customerKind = {
    ...
    set: (id, parsed) => {
        ...
        if (!data.updateCustomer(id, patch))
    ...
    actions: [
        {
            ...
            run: (id, args, ctx) => {
                ...
                if (container)
                    runSet(container, args.slice(1), ctx);
            },
        },
    ],
};
export const documentKind = {
    ...
    set: (id, parsed) => {
        ...
        if (!data.updateDocument(id, patch))
...
export const dataKinds = [customerKind, documentKind];

...
export type DocumentFields = Pick<Document, "title" | "status" | "documentDate" | "validUntil" | "discountBp" | "coverLetter" | "salutationOverride" | "projectId">;
/** Editable item fields. */
export type DocumentItemFields = Omit<DocumentItem, "id" | "catalogItemId">;
export declare const docTypeLabels: Record<DocType, string>;
export declare const docTypePrefix: Record<DocType, string>;

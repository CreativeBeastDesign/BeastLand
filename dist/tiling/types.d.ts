 ...
 */
import type { Customer, Document } from "../data/types.js";
export declare const GRID_COLUMNS = 6;
export declare const DEFAULT_SIZE: {
    readonly w: 2;
    readonly h: 2;
};
export declare const MIN_SIZE: {
    readonly w: 1;
    readonly h: 1;
};
/**
...
export type WorkspaceStore = {
    ...
    spawn(kind: ContentKind, contentId: string, opts?: {
        title?: string;
        w?: number;
        h?: number;
    }): Container;
    ...
    peekResize(id: ContainerId, size: {
        w?: number;
        h?: number;
    }): ResizeIntent;
...
export type DataStore = {
    ...
    createCustomer(fields?: Partial<import("../data/types.js").CustomerFields>): Customer;
    updateCustomer(id: string, patch: Partial<import("../data/types.js").CustomerFields>): Customer | undefined;
    deleteCustomer(id: string): boolean;
    createDocument(docType: import("../data/types.js").DocType, opts?: {
        customerId?: string;
        title?: string;
        projectId?: string | null;
    }): Document;
    updateDocument(id: string, patch: Partial<import("../data/types.js").DocumentFields>): Document | undefined;
    deleteDocument(id: string): boolean;
    addItem(docId: string, fields?: Partial<import("../data/types.js").DocumentItemFields>): import("../data/types.js").DocumentItem | undefined;
    /** `index` is 1-based, as typed in the terminal (`item 3 set …`); `"last"` is accepted. */
    updateItem(docId: string, index: number | "last", patch: Partial<import("../data/types.js").DocumentItemFields>): import("../data/types.js").DocumentItem | undefined;

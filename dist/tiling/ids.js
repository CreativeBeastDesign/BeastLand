...
export function uniquePrefixLength(bare, all) {
...
function fromShared(id, bare, shared) {
 ...
 */
export function shortIdIndex(all) {
...
export function shortId(id, all) {
 ...
 * nothing matches.
 */
export function resolveId(input, all) {

...
<script lang="ts">
  ...
  import LookPicker from "../components/molecules/LookPicker.svelte";
  import ThemePicker from "../components/molecules/ThemePicker.svelte";
  import WallpaperPicker from "../components/molecules/WallpaperPicker.svelte";

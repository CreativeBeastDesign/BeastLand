...
export declare function memoryStorage(seed?: Record<string, string>): StorageAdapter;
export declare function webStorage(area: Storage): StorageAdapter;
/** Wrap a sync adapter as an async one (tests, demos, or a sync backend behind the async seam). */
export declare function toAsync(adapter: StorageAdapter): AsyncStorageAdapter;
